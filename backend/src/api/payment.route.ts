...
function verifyFlouciSignature(req: Request): boolean {
  ...
  // 🛡️ Explicitly validate header is a single string to prevent DoS via array input
  ...
  // 🛡️ Avoid exception-based control flow (try/catch) and timing leaks by explicitly verifying lengths
