...
const globalSettingsSchema = z.object({
  ...
  buyer_orders_theme_style: z.enum(['modern_cards', 'timeline_logistics']).optional(),
  ...
  invoice_platform_matricule_fiscal: z.coerce.string().trim().max(64).optional(),
...
const operationsSettingsSchema = globalSettingsSchema
  .pick({
    ...
    image_size_thumbnail_w: true,
    image_size_thumbnail_h: true,
    image_size_thumbnail_crop: true,
    image_size_small_w: true,
    image_size_small_h: true,
    image_size_small_crop: true,
    image_size_medium_w: true,
    image_size_medium_h: true,
    image_size_medium_crop: true,
    image_size_large_w: true,
    image_size_large_h: true,
    image_size_large_crop: true,
    image_quality_webp: true,
