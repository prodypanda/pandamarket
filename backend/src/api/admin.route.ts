...
const globalSettingsSchema = z.object({
  ...
  payment_paypal_client_id: z.coerce.string().max(500).optional(),
  payment_paypal_client_secret: z.coerce.string().max(500).optional(),
  payment_paypal_webhook_id: z.coerce.string().max(500).optional(),
