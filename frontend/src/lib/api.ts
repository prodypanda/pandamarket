...
const LIVE_BACKEND_URL = 'https://pandamarket-backend-fjom.onrender.com';

/** For server components (SSR / RSC) — never exposed to the browser. */
export const BACKEND_URL =
  process.env.BACKEND_URL || process.env.NEXT_PUBLIC_BACKEND_URL || LIVE_BACKEND_URL;

/** For client components — must use NEXT_PUBLIC_ prefix to be available in the browser. */
export const PUBLIC_BACKEND_URL =
  process.env.NEXT_PUBLIC_BACKEND_URL || LIVE_BACKEND_URL;
