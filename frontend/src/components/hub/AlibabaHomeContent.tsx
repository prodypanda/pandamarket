                ...
                <div>
                  ...
                  {Number(product.compare_at_price) > Number(product.price) && (
                    <div className="flex items-center gap-1 mt-0.5">
                      ...
                      <span className="rounded bg-red-500 px-1 py-0.5 text-[9px] font-black text-white">-{Math.round(((Number(product.compare_at_price) - Number(product.price)) / Number(product.compare_at_price)) * 100)}%</span>
                    </div>
                  )}
                </div>
