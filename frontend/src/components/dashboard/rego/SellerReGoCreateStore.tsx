    ...
    <DashboardPageWrapper
      ...
      secondaryAction={
        <Link
          ...
          className="flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-xs rounded-xl transition"
        >
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                  Nom commercial de la boutique <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <input
                  type="text"
                  value={name}
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                  Sous-domaine personnalisé <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <div className="flex overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus-within:border-slate-900 dark:focus-within:border-white transition">
                  ...
                  />
                  <span className="border-s border-slate-200 dark:border-slate-700 bg-slate-100/60 dark:bg-slate-900/60 px-4 py-3 text-xs font-semibold text-slate-500 dark:text-slate-400 flex items-center font-mono">
                    .{marketplaceDomain}
                  </span>
                </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                  Type d&apos;activité commerciale <span className="text-rose-500 dark:text-rose-400">*</span>
                </label>
                <select
                  value={sellerType}
