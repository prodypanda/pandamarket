                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition whitespace-nowrap cursor-pointer ${
                      statusFilter === f.id
                        ...
                        : 'bg-white dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50'
                    }`}
                  >
                    {f.label}
                  </button>
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-2xl border transition-all cursor-pointer ${
                          isSelected
                            ? 'border-slate-900 dark:border-white bg-slate-50 dark:bg-slate-850 shadow-xs ring-1 ring-slate-900/10'
                    ...
                    <div className="flex items-center gap-2">
                      {selectedTicket.status !== 'closed' ? (
                        <button
                          ...
                          disabled={submitting}
                          className="px-2.5 py-1 text-[11px] font-bold rounded-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-100 transition cursor-pointer"
                        >
                          Clôturer le ticket
                        </button>
                      ) : (
                        <button
                          ...
                          disabled={submitting}
                          className="px-2.5 py-1 text-[11px] font-bold rounded-lg border border-slate-200 dark:border-slate-700 text-emerald-600 hover:bg-emerald-50 transition cursor-pointer"
                        >
                          Rouvrir le ticket
                        </button>
                      )}
