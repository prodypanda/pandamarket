    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <ReGoKpiHero
          ...
          delta="Immédiatement virable"
          deltaType="increase"
          deltaLabel="RIB Modulo 97"
          icon={Wallet}
        />
        <ReGoKpiHero
        ...
        left={
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmitPayout} className="space-y-3.5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-3 pr-16 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-xs font-bold font-mono text-slate-900 dark:text-white focus:ring-2 focus:ring-[#ad0505] focus:outline-none"
                  />
                  <button
                    type="button"
                    onClick={() => setPayoutAmount(String(balance))}
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] font-extrabold px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-slate-900"
                  >
                    MAX
                  </button>
                </div>
              ...
              <div>
                ...
                {bankInfo && (
                  <div className="mt-1.5 flex items-center justify-between text-[11px] p-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/30 text-emerald-800 dark:text-emerald-200 border border-emerald-200/70 dark:border-emerald-800/50">
                    ...
                    <span className="text-[10px] uppercase font-bold text-emerald-700">RIB Valide</span>
                  </div>
                )}
              ...
              {payoutError && (
                <div className="p-3 rounded-xl bg-rose-50 text-rose-800 text-xs font-bold flex items-center gap-2 border border-rose-200">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                disabled={loading}
                className="p-1.5 rounded-lg border border-slate-200 dark:border-slate-800 text-slate-500 hover:text-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 transition shadow-2xs"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right shrink-0">
                        <span className={`text-xs font-mono font-bold ${isCredit ? 'text-emerald-600' : 'text-slate-900 dark:text-white'}`}>
                          {isCredit ? '+' : '-'}
