                        ...
                        <div className="flex flex-wrap gap-1">
                          {item.health_scorecard?.risk_flags && item.health_scorecard.risk_flags.length > 0 ? (
                            item.health_scorecard.risk_flags.map((flag, idx) => (
                              <span
                                key={idx}
                                className="text-[10px] font-bold px-1.5 py-0.2 rounded bg-rose-50 text-rose-700 border border-rose-200"
                              >
                                {flag}
                              </span>
                            ))
                      ...
                      <td className="px-3 py-2.5 text-right">
                        <div className="inline-flex items-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1 rounded text-slate-500 hover:text-amber-600 hover:bg-slate-100 cursor-pointer"
                          >
        ...
        {inspectedItem && (
          <div className="space-y-4 text-xs">
            ...
            <div className="grid grid-cols-2 gap-2 font-mono">
              <div className="p-2.5 rounded border border-[var(--rego-border,#dedede)] bg-white">
            ...
            <div className="rounded-[var(--rego-r,8px)] border border-rose-200 bg-rose-50/70 p-3 space-y-2">
              <h5 className="font-bold text-rose-900 uppercase text-[11px] tracking-wide">
              ...
              <div className="flex flex-wrap gap-1.5">
                {inspectedItem.health_scorecard?.risk_flags?.map((flag, idx) => (
                  <span
                    key={idx}
                    className="text-xs font-semibold px-2 py-0.5 rounded bg-white text-rose-800 border border-rose-300"
                  >
                    ⚠️ {flag}
                  </span>
                ))}
