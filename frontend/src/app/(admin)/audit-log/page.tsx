...
const actorRoleOptions = ['all', 'admin', 'super_admin'];
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-[1.5rem] border border-emerald-100 bg-emerald-50 p-5 text-sm text-emerald-900">
            ...
            <p className="text-xs leading-5">
              State-changing superadmin API calls are captured with redacted request bodies, status codes, duration, actor role, IP, and user agent.
            </p>
          </div>
        </aside>
      </div>
