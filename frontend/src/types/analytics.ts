...
export type AnalyticsTabID = 'overview' | 'financials' | 'vendors' | 'ads' | 'system' | 'business' | 'intelligence' | 'governance' | 'page_views';
...
export interface PlatformPageViewsAnalytics {
  range: NormalizedAnalyticsRange;
  metric_scope: MetricScopeMetadata;
  summary: {
